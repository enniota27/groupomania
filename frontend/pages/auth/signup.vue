            ...
            <div class="row">    
                ...
                <div class="col">
                    ...
                    <small id="passwordHelpBlock" class="form-text text-muted">
                        Le mot de passe doit avoir au minimun 8 caractères et doit contenir une majuscule et un chiffre.
                    </small>
                </div>
            </div>
            <button @click="signup" class="btn btn-primary mb-2">S'inscrire</button>
        </form>
    </div>
</template>
